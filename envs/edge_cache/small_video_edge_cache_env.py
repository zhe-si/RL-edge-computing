...
class SmallVideoEdgeCacheEnv(AbsEnv):
    ...
    def _get_obs(self):
        ...
        obs = [
            # 下行速率，从基站到用户
            self.v_station.r0_all / self.v_station.round_step,
            self.v_station.r0_max,
            self.v_station.r0_min,
            # 回程速率，从服务器到基站
            VirtualServer.r1_all / VirtualServer.round_step,
            VirtualServer.r1_max,
            VirtualServer.r1_min,
            # 用户终端播放速率
